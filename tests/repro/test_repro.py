...
# Try to import from the installed package; if not available, skip gracefully
try:
...
@pytest.mark.skipif(not HAS_MODULE, reason="openinference-instrumentation-claude-agent-sdk not installed")
def test_repro():
